...
export const SceneRow: React.FC<SceneRowProps> = React.memo(
  ({
    ...
    const typeColor =
      scene.type === "VISUAL" ? "text-vf-lime" : "text-blue-400";
    const typeLabel =
      ...
      <div className="animate-fade-in relative pl-0 sm:pl-4 border-l-0 sm:border-l border-vf-border">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-center mt-2">
            <button
              onClick={() => onLoadMore(scene.id, scene.query, scene.page)}
  ...
  (prev, next) => {
    ...
    return (
      ...
      // Functions onSelectVideo/onLoadMore/onDurationChange are stable refs from App
    );
  }
);
